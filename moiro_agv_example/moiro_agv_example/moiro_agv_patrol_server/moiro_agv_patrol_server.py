...
from moiro_agv_example.moiro_agv_patrol_server.moiro_agv_path \
    import MoiroAgvPath
from moiro_interfaces.action import Patrol


class MoiroAgvPatrolServer(Node):

    def __init__(self):
        super().__init__('moiro_agv_patrol_server')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("moiro_agv patrol action server has been initialised.")
    ...
    *******************************************************************************"""
    ...
    async def execute_callback(self, goal_handle):
        ...
        while (feedback_msg.left_time > 0):
            ...
            # Give vel_cmd to moiro_agv
            twist = Twist()
            twist = MoiroAgvPath.drive_circle(radius, speed)
