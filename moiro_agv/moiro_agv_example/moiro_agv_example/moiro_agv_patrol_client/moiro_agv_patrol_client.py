...
class MoiroAgvPatrolClient(Node):

    def __init__(self):
        super().__init__('moiro_agv_patrol_client')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Moiro agv patrol node has been initialised.")
