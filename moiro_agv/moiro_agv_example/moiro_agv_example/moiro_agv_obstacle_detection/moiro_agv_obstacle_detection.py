...
class MoiroAgvObstacleDetection(Node):

    def __init__(self):
        super().__init__('moiro_agv_obstacle_detection')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("moiro_agv obstacle detection node has been initialised.")
