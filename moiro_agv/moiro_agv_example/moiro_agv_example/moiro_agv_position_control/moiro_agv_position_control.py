...
from moiro_agv_example.moiro_agv_position_control.moiro_agv_path import MoiroAgvPath

terminal_msg = """
moiro_agv Position Control
------------------------------------------------------
...
class MoiroAgvPositionControl(Node):

    def __init__(self):
        super().__init__('moiro_agv_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("moiro_agv position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                # self.get_logger().info(f"Angle : {numpy.rad2deg(angle)}     path_theta : {numpy.rad2deg(path_theta)}")
                twist, self.step = MoiroAgvPath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = MoiroAgvPath.go_straight(distance, linear_velocity, self.step)
