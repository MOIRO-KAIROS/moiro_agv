...
using robotis::moiro_agv::sensors::SensorState;
...
: Sensors(nh),
  ...
  sonar_(sonar)
{
  pub_ = nh->create_publisher<moiro_interfaces::msg::SensorState>(topic_name, this->qos_);
...
{
  auto msg = std::make_unique<moiro_interfaces::msg::SensorState>();
